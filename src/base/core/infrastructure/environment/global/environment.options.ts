...
class EnvironmentOptions {
  ...
  public static getValidation(): Joi.ObjectSchema {
    ...
    return Joi.object({
      ...
      NO_RELATIONAL_DATABASE_TYPE: Joi.string().required(),
      NO_RELATIONAL_DATABASE_HOST: Joi.string().required(),
      NO_RELATIONAL_DATABASE_PORT: Joi.number().port().required(),
      NO_RELATIONAL_DATABASE_NAME: Joi.string().required(),
      NO_RELATIONAL_DATABASE_USER: Joi.string().required(),
      NO_RELATIONAL_DATABASE_PASSWORD: Joi.string().required(),
      NO_RELATIONAL_DATABASE_PARAMS: Joi.string().required(),
    });
  }
